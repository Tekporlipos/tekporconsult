 ...
 @include('include/head')
  ...
  <body ondblclick="scrolling()">
    ...
    <div class="embed-responsive embed-responsive-16by9">
      <video class="embed-responsive-item" style="height: 80%; width:100%" id="videoIntro" src="/Library/VID-20200614-WA0001.m4v"  controls aria-controls="true" autoplay></video>
      </div>
