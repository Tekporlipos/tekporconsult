...
<nav class="navbar navbar-expand-lg bg-light ftco-navbar-light" id="ftco-navbar2">
      <div class="container d-flex align-items-center bg-light px-4">
        ...
        <li class="nav-item"><a href="../accounts_subscription" class="nav-link" style="color: blue">SUBSCRIPTION</a></li>
            <li class="nav-item"><a href="../accounts_repository" class="nav-link" style="color: blue"><u>REPOSITORY</u></a></li>
...
<div class="container-fluid">
  <div class="jumbotron">
    <h1 class="display-3">REPOSITORY</h1>
    <hr class="my-2">
<p class="lead">
 
<div class="container text-center">
  <button type="button" class="tag-cloud-link lg">UPLOAD FILE</button>
<button type="button" class="tag-cloud-link lg">CREATE NEW DIRECTORY</button>
</div>
