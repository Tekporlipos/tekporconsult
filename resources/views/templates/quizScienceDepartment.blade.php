...
<html lang="en">
  <head>
    <title>TekporAcademy - Games_Quizzes Departments</title>
        ...
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <p class="breadcrumbs"><span class="mr-2">
				...
				<a href="../Games"> <i class="ion-ios-arrow-forward"> Games</i></a>
				<a href="../typingClass"> <i class="ion-ios-arrow-forward">Quizzes</i></a></span> 
			...
			<div class="row">
				<div class="col-md-3 course ftco-animate">
					...
					<div class="text pt-4">
						...
						<h3><a href="Bio">Biochemistry and Biotechnology</a></h3>
						...
						<p><a href="../quizCourses/Biochemistry and Biotechnology" class="btn btn-primary">Check Out</a></p>
					</div>
				</div>
				<div class="col-md-3 course ftco-animate">
					...
					<div class="text pt-4">
						...
						<h3><a href="Food Science">Food Science and Technology</a></h3>
						...
						<p><a href="../quizCourses/Food Science and Technology" class="btn btn-primary">Check Out</a></p>
					</div>
				</div>
				<div class="col-md-3 course ftco-animate">
					...
					<div class="text pt-4">
						...
						<h3><a href="Optometry">Optometry and Visual Science</a></h3>
						...
						<p><a href="../quizCourses/Optometry and Visual Science" class="btn btn-primary">Check Out</a></p>
					</div>
				</div>
				<div class="col-md-3 course ftco-animate">
					...
					<div class="text pt-4">
						...
						<h3><a href="Chemistry">Chemistry</a></h3>
						...
						<p><a href="../quizCourses/Chemistry" class="btn btn-primary">Check Out</a></p>
					</div>
				</div>
				...
				<div class="col-md-3 course ftco-animate">
					...
					<div class="text pt-4">
						...
						<p><a href="../quizCourses/Computer Science" class="btn btn-primary">Check Out</a></p>
					</div>
				</div>
				<div class="col-md-3 course ftco-animate">
					...
					<div class="text pt-4">
						...
						<p><a href="../quizCourses/Mathematics" class="btn btn-primary">Check Out</a></p>
					</div>
				</div>
				<div class="col-md-3 course ftco-animate">
					...
					<div class="text pt-4">
						...
						<p><a href="../quizCourses/Physics" class="btn btn-primary">Check Out</a></p>
					</div>
				</div>
				...
				<div class="col-md-3 course ftco-animate">
					...
					<div class="text pt-4">
						...
						<h3><a href="Theoretical">Theoretical and Applied Biology</a></h3>
						<p>Applied Biology is the understanding of how organisms work from subcellular to whole organism level....</p>
						<p><a href="../quizCourses/Theoretical and Applied Biology" class="btn btn-primary">Check Out</a></p>
					</div>
				</div>
