...
<html lang="en">
  ...
  <button class="btn btn-lg btn-danger"><a class="text-white" href="#"> Subscribe</a></button>
    ...
    <i class="" aria-hidden="true"> <a href="../accountsuser/{{ $item->name }}">HOME</a> </i>
            ...
            <div class="col-md-3">
                <b class="" aria-hidden="true"><a href="../accounts_discustionuser/{{ $item->name }}">DISCUSSION</a></b>
            </div>
            <div class="col-md-3">
...
<div class="jumbotron">
  ...
  <p class="lead">
   <i class="fas fa-h3    ">   <div class="text-success">CONVERSATION MAY BE HIDDEN</div> </i>
  </p>
</div>
