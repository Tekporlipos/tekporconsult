      ...
      <div class="container d-flex align-items-center bg-light px-4">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav2">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item"><a href="../accounts" class="nav-link pl-0" style="color: blue"><u>HOME</u></a></li>
          ...
          <div class="container-fluid px-4">
            <div class="row">        
              ...
              <div class="col-md-3 course ftco-animate">
                ...
                <h5 class="text-center"  title="{{$quiz->title}}"><a href="../Quizname/{{$quiz->id}}" style="color:black">{{ $quiz->title  }}</a></h5>
                </div>
              </div>
