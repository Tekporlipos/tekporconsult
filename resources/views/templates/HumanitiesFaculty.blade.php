...
<html lang="en">
  <head>
    <title>TekporAcademy - Humanities Faculties</title>
        ...
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <p class="breadcrumbs"><span class="mr-2">
				...
				<a href="#"> <i class="ion-ios-arrow-forward">Humanities and Social Science Faculties</i></a></span> 
			...
			<div class="row">
				<div class="col-md-3 course ftco-animate">
					...
					<div class="text pt-4">
						...
						<h3><a href="Bio">Faculty of Law</a></h3>
				...
				<div class="col-md-3 course ftco-animate">
					...
					<div class="text pt-4">
						...
						<h3><a href="Food Science">Faculty of Social Sci.</a></h3>
				...
				<div class="col-md-3 course ftco-animate">
					...
					<div class="text pt-4">
						...
						<h3><a href="Optometry">Faculty of Business</a></h3>
