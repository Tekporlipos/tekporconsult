...
<html lang="en">
  <head>
    <title>TekporAcademy - algorithmChallenge Class</title>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="home">Home <i class="ion-ios-arrow-forward"></i></a> <a href="Games">Games <i class="ion-ios-arrow-forward"></i></a></span> <span>algorithm Challenge<i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
