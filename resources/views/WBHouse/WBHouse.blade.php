...
<head>
	...
	<!-- Author Meta -->
	<meta name="author" content="WBHouse">
	<!-- Meta Description -->
	...
	<link href="https://fonts.googleapis.com/css?family=Poppins:100,300,500" rel="stylesheet">
		...
		<link rel="stylesheet" href="{{ asset('css/wbhouse.css') }}">
	...
	<div class="oz-body-wrap">
		<!-- Start Header Area -->
		<header class="default-header ftco-animate">
			<div class="container-fluid">
				<div class="header-wrap">
					<div class="header-top d-flex justify-content-between align-items-center">
						<div class="logo">
							<a href="index.html"><img src="img/logo.png" width="50px" alt=""></a>
						</div>
		...
		<!-- End Header Area -->
		<!-- Start Banner Area -->
		<section class="banner-area relative ftco-animate">
			<div class="container">
		...
		<!-- End Banner Area -->
		<!-- Start Video Area -->
		<section class="video-area pt-40 pb-40 ftco-animate">
		...
		<!-- End Video Area -->
		<!-- Start about Area -->
		<section class="about-area pt-100 pb-100 ftco-animate">
			<div class="container">
				<div class="row align-items-center">
					<div class="col-lg-6">
						<div class="story-content">
							<h2>Brief Information <br>
							About <span>WBHouse</span></h2>
		...
		<!-- End Team Force Area -->
		<!-- Start Feature Area -->
		<section class="feature-area pt-100 pb-100  relative ftco-animate">
			<div class="overlay overlay-bg"></div>
			<div class="container">
				<div class="row">
		...
		<!-- Start Feature Area -->
		<!-- Start faq Area -->
		<section class="faq-area pt-100 pb-100 ftco-animate">
			<div class="container">
				<div class="row">
		...
		<!-- Start faq Area -->
		<!-- Start Conatct- Area -->
		<section class="contact-area pt-100 pb-100 relative ftco-animate">
			<div class="overlay overlay-bg"></div>
			<div class="container">
	...
	<script src="{{ asset('js/wbhouse.js') }}"></script>
	</body>
</html>
