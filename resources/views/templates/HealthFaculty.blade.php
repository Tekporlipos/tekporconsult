			...
			<div class="row">
				<div class="col-md-3 course ftco-animate">
					...
					<div class="text pt-4">
						...
						<p><a href="../Courses/Pharmacy and Pharmaceutical" class="btn btn-primary">Check Out</a></p>
					</div>
				</div>
				<div class="col-md-3 course ftco-animate">
					...
					<div class="text pt-4">
						...
						<p><a href="../Courses/Medical Sciences" class="btn btn-primary">Check Out</a></p>
					</div>
				</div>
				<div class="col-md-3 course ftco-animate">
					...
					<div class="text pt-4">
						...
						<p><a href="../Courses/Clinical Medicine" class="btn btn-primary">Check Out</a></p>
					</div>
				</div>
				<div class="col-md-3 course ftco-animate">
					<div class="img" style="background-image: url(/faculty/architecture-building-campus-clark-hall-207684.jpg);"></div>
					<div class="text pt-4">
						...
						<p>Optometry and Visual Science  is a health care profession that involves examining the eyes and applicable visual systems for defects or abnormalities as well as the...</p>
						<p><a href="../Courses/Health Sciences" class="btn btn-primary">Check Out</a></p>
					</div>
				</div>
				<div class="col-md-3 course ftco-animate">
					<div class="img" style="background-image: url(/faculty/architecture-building-campus-clark-hall-207684.jpg);"></div>
					<div class="text pt-4">
						...
						<p>Optometry and Visual Science  is a health care profession that involves examining the eyes and applicable visual systems for defects or abnormalities as well as the...</p>
						<p><a href="../Courses/Veterinary Medicine" class="btn btn-primary">Check Out</a></p>
					</div>
				</div>
				<div class="col-md-3 course ftco-animate">
					<div class="img" style="background-image: url(/faculty/architecture-building-campus-clark-hall-207684.jpg);"></div>
