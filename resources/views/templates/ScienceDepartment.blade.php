        ...
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <p class="breadcrumbs"><span class="mr-2">
				...
				<a href="#"> <i class="ion-ios-arrow-forward"> Collage Of Science</i></a></span> 
			...
			<div class="row">
				<div class="col-md-3 course ftco-animate">
					...
					<div class="text pt-4">
						...
						<p><a href="../Courses/Biochemistry and Biotechnology" class="btn btn-primary">Check Out</a></p>
					</div>
				</div>
				<div class="col-md-3 course ftco-animate">
					...
					<div class="text pt-4">
						...
						<p><a href="../Courses/Food Science and Technology" class="btn btn-primary">Check Out</a></p>
					</div>
				</div>
				<div class="col-md-3 course ftco-animate">
					...
					<div class="text pt-4">
						...
						<p><a href="../Courses/Optometry and Visual Science" class="btn btn-primary">Check Out</a></p>
					</div>
				</div>
				<div class="col-md-3 course ftco-animate">
					...
					<div class="text pt-4">
						...
						<p><a href="../Courses/Chemistry" class="btn btn-primary">Check Out</a></p>
					</div>
				</div>
				...
				<div class="col-md-3 course ftco-animate">
					...
					<div class="text pt-4">
						...
						<p><a href="../Courses/Computer Science" class="btn btn-primary">Check Out</a></p>
					</div>
				</div>
				<div class="col-md-3 course ftco-animate">
					...
					<div class="text pt-4">
						...
						<p><a href="../Courses/Mathematics" class="btn btn-primary">Check Out</a></p>
					</div>
				</div>
				<div class="col-md-3 course ftco-animate">
					...
					<div class="text pt-4">
						...
						<p><a href="../Courses/Physics" class="btn btn-primary">Check Out</a></p>
					</div>
				</div>
				...
				<div class="col-md-3 course ftco-animate">
					...
					<div class="text pt-4">
						...
						<p><a href="../Courses/Theoretical and Applied Biology" class="btn btn-primary">Check Out</a></p>
					</div>
				</div>
