			...
			<div class="row">
				<div class="col-md-3 course ftco-animate">
					...
					<div class="text pt-4">
						...
						<p><a href="../StoreCourses/Biochemistry and Biotechnology" class="btn btn-primary">Check Out</a></p>
					</div>
				</div>
				<div class="col-md-3 course ftco-animate">
					...
					<div class="text pt-4">
						...
						<p><a href="../StoreCourses/Food Science and Technology" class="btn btn-primary">Check Out</a></p>
					</div>
				</div>
				<div class="col-md-3 course ftco-animate">
